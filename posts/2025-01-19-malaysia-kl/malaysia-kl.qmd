...
There is an `R` package called [{riem}](https://github.com/ropensci/riem) that allows you to get hold of weather data from Automated Surface Observing Systems (ASOS).  These are weather stations found in airports all aound the world, many of which have been collecting data for more than 50 years.  The Kuala Lumpur International Airport (KLIA) dataset stretches back to 1949, but limiting myself to 2010 it looks like Kuala Lumpur's temperature hovers aound 28 °C $\pm$ 2 °C, while relative humidity hovers around 80% all year round.  It is not uncommon for several days in a month to reach 100% relative humidity.
